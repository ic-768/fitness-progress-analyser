...
const Analysis=({workouts})=>{
	...
	return(
		<div style={{display:"flex",height:"100%"}}>
			...
			<div style={{borderRadius:"5px",marginBottom:"57px",marginLeft:"20px",marginTop:"80px",padding:"40px",
				backgroundColor:"white",display:"flex",flexDirection:"column"}}>

				<h1 style={{marginBottom:"57px"}}> <IoIosArrowBack style={{cursor:"pointer"}} onClick={()=>{history.push("/") }}/> Analyse 
				</h1>
